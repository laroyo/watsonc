 ...
 *
 */
public class MeanNormalizedRelationMagnitudeByAll extends MeanMeasure implements AggregateSentenceMeasure {

	/**
	 * 
	 */
	public MeanNormalizedRelationMagnitudeByAll() { super(); }
	...
	public void init(Map<String,Integer> vectorIndex, Map<SentenceMeasure,Integer> measureIndex) {
		...
		for (SentenceMeasure m : measureIndex.keySet()) {
			if (m instanceof NormalizedRelationMagnitudeByAll) index = measureIndex.get(m);
		}
	}
