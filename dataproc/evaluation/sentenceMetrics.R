...
#Evaluation of the sentence metrics: drawing a sample of workers
#TODO: create a function to encapsulate the sampling of workers or adapt the existing one used for workerMetrics evaluation.
#TODO: generalize, to be able to use jobs and sets indinstinctively. 
