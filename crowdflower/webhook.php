...
//		fwrite($fh, $job_id);
   ...
   // change status to Finished and update run_time to final
	  ...
	  $updateruntime = mysql_query("Update history_table Set run_time = '$getruntime', status = 'Finished', status_change = 'disabled', checkbox_check = 'abled' Where job_id = '$job_id' ") or die(mysql_error());
